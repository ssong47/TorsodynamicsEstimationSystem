...
% follow this format for the pooled data directory:
    % file_dir = 'C:\ ....... \TES Design Validation Study\FSS Gen 1.0 Data\Processed_Data_Gen1\';
file_dir = '';
...
trials = [4,4,4,1,1,4,3,3]; % best trials for each subject, DO NOT CHANGE
...
for i_subject = 1:n_sub % loop through all subjects
    ...
    % Open Subject data
    data_name = strcat(file_dir,'GEN1FSS_', subjects{i_subject}, '_MASTER_DATA_TRIAL_',num2str(i_trial),'.mat');
    load(data_name);
